namespace Topping.Core.Proxy.Local
{
    ...
    {
        private GameServerState gameServerState = null;
        ...
        {
            Room r = this.GetServerState().Rooms[this.GetServerState().Players[this.UserName].CurrentRoom];
        ...
        {
            Room room = this.GetServerState().Rooms[this.GetServerState().Players[this.UserName].CurrentRoom];
        ...
        public void LeaveAnyRoom()
        {
            ...
            {
                Room r = this.GetServerState().Rooms[player.CurrentRoom];
        ...
        {
            Room room = this.GetServerState().Rooms[roomid];
