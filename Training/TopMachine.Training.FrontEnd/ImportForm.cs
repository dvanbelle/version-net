...
namespace TopMachine.Training.FrontEnd
{
    public partial class ImportForm : UserControl, IFinished, IDisposable
    {
        ...
        public void InitDropDowns()
        {
            ...
            Category.Add(new DropDownPairs("Tous les mots non joués", 0));
            Category.Add(new DropDownPairs("Tous les mots trouvés", 1));
            Category.Add(new DropDownPairs("Tous les mots non trouvés ", 2));    
            Category.Add(new DropDownPairs("Tous les mots isolés", 3));
        ...
        {
            txtGameName.Visible =  cbList.SelectedValue == null;
        ...
        private Boolean saveInDb( List<Word> LstResult ,string nameDestination, bool newDestination) 
        {
            ...
            {
                if (ladestination.GetWord(ww.Rack) == null)
                {
