...
namespace TopMachine.Training.FrontEnd
{
    public partial class TrainingConfig : UserControl, IFinished, IDisposable
    {
        ...
        public void InitDropDowns()
        {
            ...
            arl.Add(new DropDownPairs("Tous les mots non-joués", 0));
            arl.Add(new DropDownPairs("Tous les mots non-trouvés", 1));
            arl.Add(new DropDownPairs("Tous les mots", 2));
            arl.Add(new DropDownPairs("Tous les mots isolés", 3));
            arl.Add(new DropDownPairs("Tous les mots non-trouvés et isolés", 4));
