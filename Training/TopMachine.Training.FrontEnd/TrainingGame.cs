...
namespace TopMachine.Training.FrontEnd
{
    public partial class TrainingGame : UserControl, IFinished, IKeyHandler
    {
        ...
        {
            la = new ListAccessor("Training4dbo\\Lists\\" + packageKey);
        }
        ...
        private void btnNewGame_Click(object sender, EventArgs e)
        {
            ...
            switch (gameConfig.TypeOfPlay)
            {
                ...
                case 2:
                    ...
                    total[0] = gameConfig.TotalRounds * 5 / 100;
                    total[1] = gameConfig.TotalRounds * 15 / 100;
                    total[2] = gameConfig.TotalRounds * 40 / 100;
                    total[3] = gameConfig.TotalRounds * 40 / 100;
                    break;
                case 3:
        ...
        public void SetTirage()
        {
            ...
            currentWordDto = la.GetWord(currentWord);
